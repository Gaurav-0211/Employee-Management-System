...
export default function SettingsPage() {
  ...
  // Dummy logged-in employee data (replace with context/API data)
    ...
    >
      <div className="max-w-5xl mx-auto space-y-6">
        ...
        <SettingsCard
          ...
          description="Manage your profile details like name, email, and role."
          actionText="Edit Profile"
          action={() => setOpenProfileEdit(true)}
        />
        ...
        {openProfileEdit && (
          <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl max-w-2xl w-full p-6 relative">
              ...
              <EmployeeEditForm employee={currentEmployee} />
            </div>
          </div>
        )}
        ...
        >
          <Card>
            ...
            <CardContent>{/* your theme controls */}</CardContent>
          </Card>
        </motion.div>
        ...
        >
          <Card>
            ...
            <CardContent>{/* your language controls */}</CardContent>
          </Card>
        </motion.div>
        ...
        >
          <Card>
            ...
            <CardContent>{/* your privacy switches */}</CardContent>
          </Card>
        </motion.div>
      </div>
    </div>
