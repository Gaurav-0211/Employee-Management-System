...
export default function WellnessDashboard() {
  ...
  useEffect(() => {
    ...
    return () => clearTimeout(timer);
  }, [isTakingBreak, breakTimer, pushToast]);
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white p-6">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mt-6 grid grid-cols-1 md:grid-cols-4 gap-6">
          {/* Card */}
          <div className="bg-gradient-to-br from-green-50 to-green-100 p-5 rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 flex items-center gap-4">
            <div className="p-4 rounded-2xl bg-white shadow-sm">
              <Smile size={28} className="text-green-600" />
            </div>
            <div>
          ...
          {/* Card */}
          <div className="bg-gradient-to-br from-red-50 to-red-100 p-5 rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 flex items-center gap-4">
            <div className="p-4 rounded-2xl bg-white shadow-sm">
            ...
            <div>
              ...
              <div className="text-lg font-bold text-gray-900">{avgStress}</div>
            </div>
          </div>

          {/* Card */}
          <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-5 rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 flex items-center gap-4">
            <div className="p-4 rounded-2xl bg-white shadow-sm">
              <Droplet size={28} className="text-blue-600" />
            </div>
            <div>
              <div className="text-sm font-medium text-gray-600">Water</div>
              <div className="text-lg font-bold text-gray-900">
                {today.hydration || 0}/{store.meta?.hydrationGoal || 8} glasses
              </div>
              {/* Progress bar */}
          ...
          {/* Card */}
          <div className="bg-gradient-to-br from-yellow-50 to-yellow-100 p-5 rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 flex items-center gap-4">
            <div className="p-4 rounded-2xl bg-white shadow-sm">
        ...
        <section className="relative bg-white/70 mt-[2rem] backdrop-blur-md border border-gray-100 rounded-3xl p-8 shadow-xl transition hover:shadow-2xl">
          {/* Header */}
          <div className="flex justify-between items-start">
            <div>
              ...
              <p className="text-sm text-gray-500 mt-1">
                Share how you’re feeling — we’ll support you better.
              </p>
            </div>
          ...
          <div className="mt-6">
            <div className="flex gap-4">
              <button
                onClick={() => setMood("happy")}
                className={`flex-1 py-4 rounded-xl border text-sm font-medium transition-all flex flex-col items-center justify-center gap-2 shadow-sm hover:scale-105 ${
                  today.mood === "happy"
                    ? "bg-gradient-to-r from-green-500 to-green-400 text-white border-transparent shadow-lg"
                    : "bg-white text-gray-700 border-gray-200 hover:bg-green-50"
                }`}
              >
                <Smile size={22} />
              ...
              <button
                ...
                className={`flex-1 py-4 rounded-xl border text-sm font-medium transition-all flex flex-col items-center justify-center gap-2 shadow-sm hover:scale-105 ${
                  today.mood === "neutral"
                    ? "bg-gradient-to-r from-yellow-500 to-yellow-400 text-white border-transparent shadow-lg"
                    : "bg-white text-gray-700 border-gray-200 hover:bg-yellow-50"
                }`}
              >
                <Meh size={22} />
              ...
              <button
                ...
                className={`flex-1 py-4 rounded-xl border text-sm font-medium transition-all flex flex-col items-center justify-center gap-2 shadow-sm hover:scale-105 ${
                  today.mood === "stressed"
                    ? "bg-gradient-to-r from-red-500 to-red-400 text-white border-transparent shadow-lg"
                    : "bg-white text-gray-700 border-gray-200 hover:bg-red-50"
                }`}
              >
                <Frown size={22} />
          ...
          <textarea
            value={moodNote}
            onChange={(e) => setMoodNote(e.target.value)}
            className="w-full mt-2 p-4 rounded-xl border focus:outline-none focus:ring-2 focus:ring-indigo-300 text-gray-800 resize-none shadow-inner"
            placeholder="Write about your day... (private to HR)"
            rows={3}
          />
          ...
          <label className="block mt-6 text-sm font-medium text-gray-700">
            😮‍💨 Stress Level:{" "}
            <span className="font-semibold">{stressInput}/10</span>
          </label>
          <input
            aria-label="stress slider"
            type="range"
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            <button
              ...
              className="px-5 py-3 rounded-xl bg-indigo-600 text-white font-medium hover:bg-indigo-700 transition shadow-md hover:shadow-lg"
            >
              💾 Save Check-In
            </button>
            ...
            <button
              ...
              className="px-5 py-3 rounded-xl bg-gray-100 text-gray-700 font-medium hover:bg-gray-200 transition shadow-sm"
            >
              🔄 Reset
            </button>
            ...
            <button
              onClick={() => startBreathing()}
              className="ml-auto inline-flex items-center gap-2 px-5 py-3 rounded-xl bg-gradient-to-r from-green-500 to-green-600 text-white font-medium hover:from-green-600 hover:to-green-700 transition shadow-md hover:shadow-lg"
            >
              <Heart size={18} /> Breathe (2m)
            </button>
          </div>
        </section>
        ...
        <div className="mt-6 grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-6">
            ...
            <section className="bg-white/80 backdrop-blur-md rounded-3xl p-8 shadow-xl transition hover:shadow-2xl">
              ...
              <div className="mt-5 space-y-4">
                {recommendations.map((r) => (
                  <div
                    key={r.id}
                    className="p-5 rounded-2xl bg-gradient-to-br from-gray-50 to-white border shadow-sm hover:shadow-md transition transform hover:-translate-y-1"
                  >
                    <div className="flex justify-between items-start gap-6">
                      ...
                      <div className="flex flex-col items-end gap-2">
                        <button
                          onClick={() => startBreak(300)}
                          className="px-4 py-2 rounded-xl text-sm font-medium bg-yellow-100 text-yellow-800 border border-yellow-200 hover:bg-yellow-200 transition shadow-sm"
                        >
                          ☕ Take 5m Break
                        </button>
                        <button
                          onClick={() => startBreathing()}
                          className="px-4 py-2 rounded-xl text-sm font-medium bg-green-100 text-green-800 border border-green-200 hover:bg-green-200 transition shadow-sm"
                        >
                          🧘 Guided Breathe
                        </button>
                      </div>
                ...
                {/* Tip Box */}
                <div className="mt-4 flex items-start gap-2 text-xs text-gray-500 bg-gray-50 rounded-xl p-3 border border-dashed">
                  <span className="text-blue-500">🔒</span>
                  <p>
                    Your inputs are <span className="font-medium">private</span>{" "}
                    — only HR can view your feedback.
                  </p>
                </div>
              </div>
            </section>
          ...
          <div className="lg:col-span-2 space-y-6">
            {/*------- Weekly stress chart ------ */}
            {/* Enhanced Weekly Stress Trend */}
            <section className="bg-white/80 backdrop-blur-md rounded-3xl p-8 shadow-xl hover:shadow-2xl transition">
              {/* Header */}
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    Track how your stress levels changed over the last 7 days
                  </p>
                </div>
                <div className="text-sm font-medium text-gray-600 bg-red-50 text-red-600 px-3 py-1 rounded-full">
                  Avg: {avgStress}
                </div>
              </div>
              ...
              <div className="mt-4 text-xs text-gray-400 flex items-center gap-2">
                <span>
                  🔔 Tip: Consistent breaks & deep breathing can reduce stress
                  spikes.
                </span>
              </div>
            </section>
