...
export default function Topbar({ sidebarOpen, setSidebarOpen, visible }) {
  ...
  return (
    <header
      className="fixed top-0 left-0 right-0 flex items-center justify-between px-6 py-4 bg-white shadow-md z-40 transition-transform duration-300"
      style={{
    ...
    >
      ...
      <h2 className="text-lg font-semibold text-slate-700">Welcome to EMS!</h2>
